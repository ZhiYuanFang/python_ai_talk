...
old_struct = """// AnalyzeIntentResponse 意图分析响应体
// 与 Python 服务的返回结构对齐
...
if old_struct in content:
    ...
    print("ERROR: Could not find the old struct pattern!")
    print("Searching for partial match...")
    if "// AnalyzeIntentResponse" in content:
        print("Found: // AnalyzeIntentResponse")
    if "type AnalyzeIntentResponse struct" in content:
        print("Found: type AnalyzeIntentResponse struct")
